...
<!-- Navbar -->
    ...
    <article class="col-start-2 col-span-4 pt-6 pr-6 w-full h-full  ">
                ...
                <div class="w-full h-full gap-6 drop-shadow-[0_0px_3px_rgba(0,0,0,0.5)]">
                    ...
                    <!-- Add department -->
                            <form class="w-full flex-col flex items-end gap-1" method="POST">
                                ...
                                <button type="submit" name="AddDep" class="px-4 py-1 bg-red-500 rounded text-white border border-red-500 font-semibold transition ease-out duration-300 hover:bg-white hover:text-red-500 hover:border-red-500 drop-shadow-[2px_2px_0px_black] hover:drop-shadow-[2px_2px_0px_#ef4444] " id="addDeptButton">Add Department</button>
                            </form>
                        ...
                        <div class=" w-full ">
                            <table class="w-full ">
                                ...
                                ?>
                                    <tr>   <!-- rowsss from database will be displayed -->
                                        <td class="border-b-2 border-gray-100 py-1"><?php echo $num; ?></td>
                                        <td class="border-b-2 border-gray-100 py-1"><?php echo $rowdep['dep_name']; ?> </td>
                                        <td class="flex justify-end gap-2 border-b-2 border-gray-100 py-1"><span class="border-r-2 border-gray-300 px-2">
                                            <a href="department_mgmt.php?id=<?php echo $rowdep['dep_id']; ?>"><div class="font-semibold bg-green-500 w-16 text-white text-center rounded border border-green-500 drop-shadow-[2px_2px_0px_black] hover:drop-shadow-[2px_2px_0px_#22c55e] transition duration-300 ease-out hover:text-green-500 hover:bg-white">Edit</div></a></span>
                                            <span> <a href="department_mgmt.php?delid=<?php echo $rowdep['dep_id']; ?>" ><div class="font-semibold bg-red-500 text-white w-16 text-center rounded border border-red-500 drop-shadow-[2px_2px_0px_black] hover:drop-shadow-[2px_2px_0px_#ef4444] transition duration-300 ease-out hover:text-red-500 hover:bg-white">Delete</div></span></td>
                                    </tr>
                                    <?php } 
                                    } //end of while ?>
                                </tbody>
                            ...
                            ?>
                                ...
                                <!-- Display selected department name -->
                                    ...
                                    <button name="edit" class="px-10 py-1 border border-red-500 hover:bg-white hover:text-red-500 transition ease-out duration-300 bg-red-500 text-white font-semibold rounded drop-shadow-[2px_2px_0px_black] hover:drop-shadow-[2px_2px_0px_#ef4444]" id="deptNewNameButton">Save</button>
                                </form>    
                                    <?php
                            ...
                            <form class="flex h-[100%] flex-col" method="POST" >
                                ...
                                <div class=" h-full flex items-end ">
                                    <div class="w-full flex justify-between border-t-2 border-gray-200 pt-3">
                                        ...
                                        <button type="submit" name="mergeDep" class="px-14 border border-red-500 text-white bg-red-500 text-lg font-semibold rounded transition ease-out duration-300 hover:bg-white hover:text-red-500 hover:border-red-500 drop-shadow-[2px_2px_0px_black] hover:drop-shadow-[2px_2px_0px_#ef4444]" id="logOutButton">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="flex w-full h-full justify-center items-center">
            <div class="h-56 w-80 fixed rounded drop-shadow-[0_0px_3px_rgba(0,0,0,0.5)]" >
                <div class="bg-white h-full w-full flex flex-col rounded-md">
                    <p class="text-black font-bold pl-2 py-2 self-start w-full flex border-b"><img src="./image/icons8-logout-64.png" alt="logut" width="20" height="20">Log Out</p>
...
<script src="../GSOInvSys/script/jscript.js"></script>
<?php endif ?>
</body>
</html>
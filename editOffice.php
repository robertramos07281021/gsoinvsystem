...
function find_by_id($table, $id) {
    ...
    $sql = "SELECT * FROM " . $table . " WHERE office_id = " . (int)$id;
...
$office = find_by_id('office', (int)$_GET['id']);
if (!$office) {
    $_SESSION['message'] = "Missing office ID.";
...
if (isset($_POST['edit_office'])) {
    ...
    if (empty($errors)) {
        $sql = "UPDATE office SET officeName = '{$officeName}' WHERE office_id = '{$office['office_id']}'";
        if ($connection->query($sql)) {
            $_SESSION['message'] = "Successfully Updated Office";
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>
                        ...
                        <span>Editing <?php echo remove_junk(ucfirst($office['officeName'])); ?></span>
                    </strong>
                </div>
                <div class="panel-body">
                    <form method="post" action="editOffice.php?id=<?php echo (int)$office['office_id']; ?>">
                        <div class="form-group">
                            <input type="text" class="form-control" name="officeName"
                                value="<?php echo remove_junk(ucfirst($office['officeName'])); ?>">
                        </div>
